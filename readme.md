...
*   **Interactive UI**:
    ...
    *   **Floating Info Panel**: Checkbox to show/hide; drag its header to place anywhere on the chart; close button hides and unchecks. Shows the same fundamentals as before (P/E, Market Cap, Beta, dividend/yield, ETF profile).
...
| **Info Panel** | Checkbox to show/hide the floating fundamentals overlay; drag the header to move; close (`×`) also hides/unchecks. |
